...
(public, e.g. :27271)                        (loopback only, e.g. :27270)
```
...
aglink_chat:
  ...
  addr: "127.0.0.1:27271" # 브라우저 UI 주소 (기본값)
...
> 섹션을 별도로 지정하면 되고, 아니면 기본값(`127.0.0.1:27270`, 토큰 자동 생성)이 쓰입니다.
...
- **브라우저 토큰**: `~/.teleclaude/web_chat.token` (재사용 — 이미 열린 탭이 재연결됨). 접속 URL은
  기동 로그에 `http://127.0.0.1:27271/?token=...` 형태로 출력됩니다.
